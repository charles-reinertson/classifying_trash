...
def restore_latest_checkpoint(model, checkpoint_dir, cuda=False,
    pretrain=False):
    """
    If a checkpoint exists, restores the PyTorch model from the latest checkpoint.
    Returns just the model.
    """
    ...
    if not cp_files:
        ...
        raise Exception("No saved models, quitting program")
    ...
    try:
        ...
        raise Exception("=> Checkpoint not successfully restored")
